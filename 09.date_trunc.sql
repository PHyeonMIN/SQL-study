...
select trunc(99.9999, 2);													-- trunc 뒤를 짜르다, 소수점 2자리 이하를 구해라
...
select date_trunc('day', to_date('2022-03-03', 'yyyy-mm-dd')) as date_01;	-- timestamp 타입
...
select date_trunc('year', '2022-03-03'::date)::date as date_02;				-- 1월 1일
...
-- week의 시작 날짜 구하기. 일요일 기준.											-- 일반적으로 week의 시작은 일요일부터 하는게 좋다.
